...
SECRET_KEY = 'django-insecure-#=l8v=l=b-q5p#c5ks*$8%u)u++^dh8ye*s2=*ul1u2vi9ec-%'
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Mon API",
    "DESCRIPTION": "Documentation OpenAPI pour Mon API",
    "VERSION": "1.0.0",
    # Pour ajouter Bearer JWT dans Swagger UI:
    "COMPONENTS": {
        "securitySchemes": {
            "BearerAuth": {
                "type": "http",
